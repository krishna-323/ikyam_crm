...
class EditMasterDetails extends StatefulWidget {
  final double drawerWidth;
  final double selectedDestination;
  final Map storeData;
  const EditMasterDetails({super.key,
    required this.drawerWidth,
    required this.selectedDestination, required this.storeData});

  @override
  State<EditMasterDetails> createState() => _EditMasterDetailsState();
}

class _EditMasterDetailsState extends State<EditMasterDetails> {


  @override
  void initState() {
    // TODO: implement initState.
    itemCodeController.text=widget.storeData['item_code'];
    sellingPriceController.text=widget.storeData['selling_price'].toString();
    purchaseController.text=widget.storeData['purchase_price'].toString();
    partNameController.text=widget.storeData['name'];
    descriptionController.text=widget.storeData['description'];
    exemptionController.text=widget.storeData['exemption_reason'];
    partUOMTypeController.text=widget.storeData['unit'];
    goodsTypeController.text=widget.storeData['type'];
    taxPreController.text=widget.storeData['tax_preference'];
    super.initState();
  }
            ...
            child: Scaffold(
              appBar: PreferredSize(
                ...
                child: AppBar(automaticallyImplyLeading: false,
                  ...
                  title: const Text("Edit Parts Details"),
                  actions: [
                    Padding(
          ...
          Expanded(child: Scaffold(
            appBar: PreferredSize(
              ...
              child: AppBar(
                ...
                surfaceTintColor: Colors.white,
                shadowColor: Colors.black,
                title: const Text("Edit Master Details"),
                actions: [
                  Padding(
                    padding: const EdgeInsets.only(right: 50.0),
                    child: SizedBox(
